...
module.exports = {
    ...
    execute(client, message, args) {
		const mapsList = fs.readdirSync(mapsFolder).map(mapName => mapName.slice(0, -4)).map(mapName => '[' + mapName + ']' + '(https://www.soldat-ttw.com/maps/#ttw/' + mapName + ')').sort(function (a, b) {
